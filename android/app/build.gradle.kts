...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 35 // Replace with the actual targetSdkVersion
        versionCode = 7 // Replace with the actual versionCode
        versionName = "1.0.4" // Replace with the actual versionName
    }
    signingConfigs {
        create("release") {
